...
A1 = world
B1 = world.addFrame(name='B', p=[-5.5,0,0])
...
C4 = bar4.addFrame(name='C', p=[-0.5,-1.5,0])
#world.addVisualisation.Frame(C4, 1)
E4 = bar4.addFrame(name='E', p=[ 0.5,-1.5,0])
#world.addVisualisation.Frame(E4, 3)
C4_Line = C4.addFrame('C_Line', R=rotMat(-arctan(1.5/0.5), 'z'))
world.addVisualisation.Line(C4_Line, sqrt(1.5**2+0.5**2), name='Body4_1')
E4_Line = E4.addFrame('E_Line', R=rotMat(arctan(1.5/0.5), 'z'))
world.addVisualisation.Line(E4_Line, -sqrt(1.5**2+0.5**2), name='Body4_2')
world.addVisualisation.Line(C4, 1, name='Body4_3')
...
jD = world.addJoint(name='Rot_jD', CS1=D6, CS2=D5, dofList='Rz', startVals=2)
jF = world.addJoint(name='Rot_jF', CS1=F1, CS2=F4, dofList='Rz', startVals=-2.5)
...
if (dae == True):
    ...
    # ThreeBarTrans
    world.addLoop.ThreeBarTrans(C3, C4, name='ThreeBarTrans')

print("System has been assembled")

world.genEquations.Recursive()
world.genCode.Modelica('Watt', '.\Output')
world.show('Watt')