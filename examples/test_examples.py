...
class TestExamples(unittest.TestCase):
    ...
    def test_inverted_pendulum(self):
        ...
        exec(compile(open(os.path.join(controller_path,'inverted_pendulum.py')).read(), os.path.join(controller_path,'InvertedPendulum.py'), 'exec'))

    def test_controlled_mass_spring_damper(self):
        controller_path = os.path.join(self.controlled_examples_dir,
                                       'mass_spring_damper')
        sys.path.append(controller_path)
        exec(compile(open(os.path.join(controller_path,'mass_spring_damper.py')).read(), os.path.join(controller_path,'MassSpringDamper.py'), 'exec'))
    ...
    def test_overhead_crane(self):
        ...
        sys.path.append(controller_path)
        print(sys.path)
        exec(compile(open(os.path.join(controller_path,'overhead_crane.py')).read(), os.path.join(controller_path,'OverheadCrane.py'), 'exec'))
