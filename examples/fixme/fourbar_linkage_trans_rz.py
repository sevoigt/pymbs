...
jB = world.addJoint('jB', bar2.CS_B, bar3.CS_B, 'Rz')
jD = world.addJoint('jD', world.CS_D, bar4b.CS_D, 'Rz')
...
if (dae == True):
    ...
    world.addLoop.FourBarTrans(bar3.CS_C, bar4a.CS_C, name='FourBarTrans')
