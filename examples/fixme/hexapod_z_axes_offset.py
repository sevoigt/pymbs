...
'''
phi_BP_1 = world.addParam('Phi_BP_1', - pi/18)
phi_BP_2 = world.addParam('Phi_BP_2',phi_BP_1 + pi/9)
phi_BP_3 = world.addParam('Phi_BP_3',phi_BP_1 + 2*pi/3)
phi_BP_4 = world.addParam('Phi_BP_4',phi_BP_2 + 2*pi/3)
phi_BP_5 = world.addParam('Phi_BP_5',phi_BP_3 + 2*pi/3)
phi_BP_6 = world.addParam('Phi_BP_6',25*pi/18)

phi_AP_1 = world.addParam('Phi_AP_1',- pi/3 + pi/18)
phi_AP_2 = world.addParam('Phi_AP_2', pi/3 - pi/18)
phi_AP_3 = world.addParam('Phi_AP_3',phi_AP_1 + 2*pi/3)
phi_AP_4 = world.addParam('Phi_AP_4',phi_AP_2 + 2*pi/3)
phi_AP_5 = world.addParam('Phi_AP_5',phi_AP_3 + 2*pi/3)
phi_AP_6 = world.addParam('Phi_AP_6',29*pi/18)
...
BP = world.addBody(name='Basisplattform',mass=1)

BP.addFrame(name='BP_visual', p=[0,0,0],R=rotMat(pi/2,'x'))

BP.addFrame(name='BP_Anlenkpunkt_1', p=[R1*cos(phi_BP_1),R1*sin(phi_BP_1),0],R=rotMat(0,'z'))
BP.addFrame(name='BP_Anlenkpunkt_2', p=[R1*cos(phi_BP_2),R1*sin(phi_BP_2),0],R=rotMat(0,'z'))
BP.addFrame(name='BP_Anlenkpunkt_3', p=[R1*cos(phi_BP_3),R1*sin(phi_BP_3),0],R=rotMat(0,'z'))
BP.addFrame(name='BP_Anlenkpunkt_4', p=[R1*cos(phi_BP_4),R1*sin(phi_BP_4),0],R=rotMat(0,'z'))
BP.addFrame(name='BP_Anlenkpunkt_5', p=[R1*cos(phi_BP_5),R1*sin(phi_BP_5),0],R=rotMat(0,'z'))
BP.addFrame(name='BP_Anlenkpunkt_6', p=[R1*cos(phi_BP_6),R1*sin(phi_BP_6),0],R=rotMat(0,'z'))

BP.addFrame('BP_Feder',p=[0.,0.,1.1])

world.addJoint(world,BP)
...
AP.addFrame(name='AP_Anlenkpunkt_1', p=[R2*cos(phi_AP_1),R2*sin(phi_AP_1),0],R=rotMat(0,'z'))
AP.addFrame(name='AP_Anlenkpunkt_2', p=[R2*cos(phi_AP_2),R2*sin(phi_AP_2),0],R=rotMat(0,'z'))
AP.addFrame(name='AP_Anlenkpunkt_3', p=[R2*cos(phi_AP_3),R2*sin(phi_AP_3),0],R=rotMat(0,'z'))
AP.addFrame(name='AP_Anlenkpunkt_4', p=[R2*cos(phi_AP_4),R2*sin(phi_AP_4),0],R=rotMat(0,'z'))
AP.addFrame(name='AP_Anlenkpunkt_5', p=[R2*cos(phi_AP_5),R2*sin(phi_AP_5),0],R=rotMat(0,'z'))
AP.addFrame(name='AP_Anlenkpunkt_6', p=[R2*cos(phi_AP_6),R2*sin(phi_AP_6),0],R=rotMat(0,'z'))
...
world.addJoint(BP.BP_Anlenkpunkt_1,Gelenk_1_BP.Gelenk_1_BP_CS_1,'Ry',name='Gelenk_1_BP_an_BP')
world.addJoint(Gelenk_1_BP.Gelenk_1_BP_CS_2,Zyl_geh_1.Zyl_geh_1_cs_2, 'Rx',name='Zyl_geh_1_an_Gelenk_1_BP')
world.addJoint(Zyl_geh_1.Zyl_geh_1_cs,Zyl_stange_1.Zyl_stange_1_cs_2, ['Tz','Rz'],name='Zyl_stange_1_an_Zyl_geh_1')
world.addJoint(Zyl_stange_1.Zyl_stange_1_cs,Gelenk_1_AP.Gelenk_1_AP_CS_1,'Rx',name='Gelenk_1_AP_an_Zyl_stange_1')

world.addJoint(BP.BP_Anlenkpunkt_2,Gelenk_2_BP.Gelenk_2_BP_CS_1,'Ry',name='Gelenk_2_BP_an_BP')
world.addJoint(Gelenk_2_BP.Gelenk_2_BP_CS_2,Zyl_geh_2.Zyl_geh_2_cs_2, 'Rx',name='Zyl_geh_2_an_Gelenk_2_BP')
world.addJoint(Zyl_geh_2.Zyl_geh_2_cs,Zyl_stange_2.Zyl_stange_2_cs_2, ['Tz','Rz'],name='Zyl_stange_2_an_Zyl_geh_2')
world.addJoint(Zyl_stange_2.Zyl_stange_2_cs,Gelenk_2_AP.Gelenk_2_AP_CS_1,'Rx',name='Gelenk_2_AP_an_Zyl_stange_2')

world.addJoint(BP.BP_Anlenkpunkt_3,Gelenk_3_BP.Gelenk_3_BP_CS_1,'Ry',name='Gelenk_3_BP_an_BP')
...
world.addJoint(BP.BP_Anlenkpunkt_4,Gelenk_4_BP.Gelenk_4_BP_CS_1,'Ry',name='Gelenk_4_BP_an_BP')
...
world.addJoint(BP.BP_Anlenkpunkt_5,Gelenk_5_BP.Gelenk_5_BP_CS_1,'Ry',name='Gelenk_5_BP_an_BP')
...
world.addJoint(BP.BP_Anlenkpunkt_6,Gelenk_6_BP.Gelenk_6_BP_CS_1,'Ry',name='Gelenk_6_BP_an_BP')
...
world.addVisualisation.File(Gelenk_1_BP.Gelenk_1_BP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_1_unten')
world.addVisualisation.File(Gelenk_1_AP.Gelenk_1_AP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_1_oben')

world.addVisualisation.File(Gelenk_2_BP.Gelenk_2_BP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_2_unten')
world.addVisualisation.File(Gelenk_2_AP.Gelenk_2_AP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_2_oben')

world.addVisualisation.File(Gelenk_3_BP.Gelenk_3_BP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_3_unten')
world.addVisualisation.File(Gelenk_3_AP.Gelenk_3_AP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_3_oben')

world.addVisualisation.File(Gelenk_4_BP.Gelenk_4_BP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_4_unten')
world.addVisualisation.File(Gelenk_4_AP.Gelenk_4_AP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_4_oben')

world.addVisualisation.File(Gelenk_5_BP.Gelenk_5_BP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_5_unten')
world.addVisualisation.File(Gelenk_5_AP.Gelenk_5_AP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_5_oben')

world.addVisualisation.File(Gelenk_6_BP.Gelenk_6_BP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_6_unten')
world.addVisualisation.File(Gelenk_6_AP.Gelenk_6_AP_visual, 'C:\\Users\JeSche\Desktop\Diplom_Arbeit\Hexapod/gelenk_mit_AV.stl',1,name='Gelenk_6_oben')


##world.addVisualisation.Frame(AP.AP_Anlenkpunkt_1,0.5)
##world.addVisualisation.Frame(world.BP_Anlenkpunkt_1,0.5)
##world.addVisualisation.Frame(Gelenk_1_AP.Gelenk_1_AP_CS_2,0.5)
##
...
world.addHydCylSensorsLoads('HP_Zylinder1',Zyl_geh_1.Zyl_geh_1_cs_2,Zyl_stange_1.Zyl_stange_1_cs)
world.addHydCylSensorsLoads('HP_Zylinder2',Zyl_geh_2.Zyl_geh_2_cs_2,Zyl_stange_2.Zyl_stange_2_cs)
world.addHydCylSensorsLoads('HP_Zylinder3',Zyl_geh_3.Zyl_geh_3_cs_2,Zyl_stange_3.Zyl_stange_3_cs)
world.addHydCylSensorsLoads('HP_Zylinder4',Zyl_geh_4.Zyl_geh_4_cs_2,Zyl_stange_4.Zyl_stange_4_cs)
world.addHydCylSensorsLoads('HP_Zylinder5',Zyl_geh_5.Zyl_geh_5_cs_2,Zyl_stange_5.Zyl_stange_5_cs)
world.addHydCylSensorsLoads('HP_Zylinder6',Zyl_geh_6.Zyl_geh_6_cs_2,Zyl_stange_6.Zyl_stange_6_cs)

#world.addSensor.Position(world,AP.AP_Anlenkpunkt_1,"P_AP_1")


#world.addSensor.Energy(world,'E_ges')
...
world.genCode.Modelica('hexapod_z_m_AV_kpl_V2','.\HP_Output',inputsAsInputs=False, debugMode=False)
'''
if (USE_LOOPS):
    world.genCode('m', 'hexapod_z_kpl_mF','.\HP_Output', debugMode=False)
else:
    world.genCode('m', 'hexapod_z_kpl_mF_DAE','.\HP_Output', debugMode=False)
