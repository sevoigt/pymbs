...
template<class T> inline bool operator!=(intrusive_ptr<T> const & a, void*)
{
    return a.get() != 0;
}
...
template<class T> inline bool operator!=(void*, intrusive_ptr<T> const & b)
{
    return 0 != b.get();
}
