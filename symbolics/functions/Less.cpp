...
/*****************************************************************************/
Less::Less( BasicPtrVec const& args ): BinaryOp(Type_Less, args)
/*****************************************************************************/
{
    // Shape berechnen
    if (getArg1()->getShape() != getArg2()->getShape())
        throw InternalError("Less shapes not equal!");
...
/*****************************************************************************/
Less::Less( BasicPtr const& arg1, BasicPtr const& arg2 ): BinaryOp(Type_Less, arg1, arg2)
/*****************************************************************************/
{
    // Shape berechnen
    if (getArg1()->getShape() != getArg2()->getShape())
...
{
#ifdef _DEBUG
    return "less(" + getArg1()->toString() + "," + getArg2()->toString() + ")";
#else
...
/*****************************************************************************/
BasicPtr Less::New( BasicPtr const& arg1, BasicPtr const& arg2)
/*****************************************************************************/
{
