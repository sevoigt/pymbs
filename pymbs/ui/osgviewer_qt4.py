...
if  __name__ == "__main__":
    ...
    node = osg.Group()
    # open a file
    osgDB.setLibraryFilePathList('C:\\Python26\\lib\\site-packages\\osgswig-0.9.1')
    loadedmodel = osgDB.readNodeFile(r'D:\Mensch-Maschine\Simulation\devel\configs\Teststrecke\Untergrund.osg')
