...
class Body(AbstractBody, Frame):
    ...
    def __init__(self, name, mass, cg, inertia):
        ...
        # (by convenience) is passed somewhere where a CS is expected
    ...
    def _insertCS(self, cs):
        ...
        # this was just for writing convenience in the input file
...
class FlexibleBody(AbstractBody, Frame):
    ...
    def __init__(self, name, filepath):
        ...
        try:
            ...
            print(f'Could not read sid-file: {fe.message}')
        ...
        for node in self.sid.modal.frame.Knoten:
            ...
            node.frame = Frame.addFrame(self, name='node_%i' %
                                        node_number, p=pos_node, R=eye((3, 3)))
    ...
    def node(self, i):
        ...
        if ((i < 1) or (i > self.sid.nNodes)):
            raise NotImplementedError(
                "Node %i doesn´t exist! Index must be in range [1,%i]", (i, self.sid.nNodes))
